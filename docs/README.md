...
│   └── CLAUDE_GHA_PIPELINES.md # Codex GitHub Actions documentation
│
...
- **[operations/CLAUDE_GHA_PIPELINES.md](./operations/CLAUDE_GHA_PIPELINES.md)** - Codex GitHub Actions pipelines
