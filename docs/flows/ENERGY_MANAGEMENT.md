...
When energy is abundant (white level), the load shedding plugin activates **thermal battery** mode, shifting HVAC setpoints ±3°F to pre-condition the house and store thermal energy in the building mass.
