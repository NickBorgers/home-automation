...
type Context struct {
	...
	// AlertNotifier dispatches alerts to both push (ntfy) and TTS channels from
	// a single call. Prefer this over NtfyClient and Notifier for new plugins and
	// when migrating existing plugins.
