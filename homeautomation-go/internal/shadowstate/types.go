...
type SleepHygieneOutputs struct {
	WakeSequenceStatus    string                    `json:"wakeSequenceStatus"` // "inactive", "begin_backup_wake", "wake_in_progress", "complete"
	...
	BackupWakeEnabled     bool                      `json:"backupWakeEnabled"`               // Whether backup wake is currently enabled
	LastAvailabilityCheck time.Time                 `json:"lastAvailabilityCheck,omitempty"` // When Eight Sleep availability was last checked
	LastActionTime        time.Time                 `json:"lastActionTime"`
	LastActionType        string                    `json:"lastActionType,omitempty"` // "begin_backup_wake", "backup_wake", "stop_screens", "go_to_bed", "cancel_wake"
	LastActionReason      string                    `json:"lastActionReason,omitempty"`
}
